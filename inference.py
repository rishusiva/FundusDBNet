...
from segretino.unet import FundusDBNet
...
class SegRetino(object):
    ...
    def inference(self, set_weight_dir = 'FundusDBNet.pth', path = 'output.png', blend = True, blend_path = 'blend.png'):
        ...
        def download_weights():
            ...
            with open(__PREFIX__+"/config/weights_download.json") as fp:
                ...
                url = 'https://drive.google.com/uc?id={}'.format(json_file['FundusDBNet.pth'])
                gdown.download(url, __PREFIX__+"/weights/FundusDBNet.pth", quiet=False)
                set_weight_dir = "FundusDBNet.pth"
